...
base='stream.tv.kodi@gmail.com'
ADDON=xbmcaddon.Addon(id='plugin.video.streamtvwizard')
...
def CATEGORIES():
    link = OPEN_URL('http://www.mediafire.com/file/b8xpc6vs7y5cx3s/wizard.txt').replace('\n','').replace('\r','')
...
def wizard(name,url,description):
    ...
    dp.create("Stream TV Wizard","Downloading ",'', 'Please Wait')
